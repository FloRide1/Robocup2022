    ...
    public class TrajectoryGeneratorHolonome
    {
        ...
        void InitPositionPID()
        {
            ...
            switch (gameMode)
            {
                case GameMode.RoboCup:
                    {
                        PID_X = new AsservissementPID(kp: 50.0, ki: 0.0, kd: 4.0, 10, 10, 10);
                        PID_Y = new AsservissementPID(kp: 50.0, ki: 0.0, kd: 4.0, 10, 10, 10);
        ...
        //Input Events
        public void OnForcedLocationReceived(object sender, EventArgsLibrary.LocationArgs e)
        {
            InitRobotPosition(e.Location.X, e.Location.Y, e.Location.Theta);
        }
        ...
        public void OnTrajectoryConstantsReceived(object sender, EventArgsLibrary.TrajectoryGeneratorConstants e)
        {
            if (e.RobotId == robotId)
            {
                accelLineaireMax = e.accelLineaireMax;
                accelRotationCapVitesseMax = e.accelRotationCapVitesseMax;
                accelRotationOrientationRobotMax = e.accelRotationOrientationRobotMax;

                vitesseLineaireMax = e.vitesseLineaireMax;
                vitesseRotationCapVitesseMax = e.vitesseRotationCapVitesseMax;
                vitesseRotationOrientationRobotMax = e.vitesseRotationOrientationRobotMax;
            }
        }
        public void OnPolarPositionPIDConstantsReceived(object sender, EventArgsLibrary.PolarPIDSetupArgs e)
        {
            ///Mise à jour des paramètres de l'asservissement PID en position
            PID_X.Init(kp: e.P_x, ki: e.I_x, kd: e.D_x, e.P_x_Limit, e.I_x_Limit, e.D_x_Limit);
            PID_Y.Init(kp: e.P_y, ki: e.I_y, kd: e.D_y, e.P_y_Limit, e.I_y_Limit, e.D_y_Limit);
            PID_Theta.Init(kp: e.P_theta, ki: e.I_theta, kd: e.D_theta, e.P_theta_Limit, e.I_theta_Limit, e.D_theta_Limit);
        }
