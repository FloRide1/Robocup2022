...
namespace MessageProcessorNS
{
    public class MsgProcessor
    {
        ...
        public void ProcessDecodedMessage(Int16 command, Int16 payloadLength, byte[] payload)
        {
            ...
            switch (command)
            {
                ...
                case (short)Commands.R2PC_PowerMonitoringEnableStatus:
                    ...
                    break;
                case (short)Commands.R2PC_Uart1ForwardRX:
                    OnRAWUART1MessageDecoded(payload);
                    break;
                case (short)Commands.R2PC_Uart2ForwardRX:
                    OnRAWUART2MessageDecoded(payload);
                    break;
                case (short)Commands.R2PC_Uart3ForwardRX:
                    OnRAWUART3MessageDecoded(payload);
                    break;
        ...
        public event EventHandler<Independant4WheelsPidCorrectionArgs> On4WheelsSpeedIndependantPidCorrectionsFromRobotEvent;
        ...
        {
            On4WheelsSpeedIndependantPidCorrectionsFromRobotEvent?.Invoke(this, new Independant4WheelsPidCorrectionArgs
            {
                CorrPM1 = corrPM1,
                CorrIM1 = corrIM1,
                CorrDM1 = corrDM1,
        ...
        public event EventHandler<Independant2WheelsPidCorrectionArgs> On2WheelsSpeedIndependantPidCorrectionDataFromRobotEvent;
        ...
        {
            On2WheelsSpeedIndependantPidCorrectionDataFromRobotEvent?.Invoke(this, new Independant2WheelsPidCorrectionArgs
            {
                CorrPM1 = corrPM1,
                CorrIM1 = corrIM1,
                CorrDM1 = corrDM1,
        ...
        public event EventHandler<DataReceivedArgs> OnRAWUART1MessageDecodedEvent;
        public virtual void OnRAWUART1MessageDecoded(byte[] msgPayload)
        {
            var handler = OnRAWUART1MessageDecodedEvent;
            if (handler != null)
            {
                handler(this, new DataReceivedArgs { Data= msgPayload});
            }
        }
        public event EventHandler<DataReceivedArgs> OnRAWUART2MessageDecodedEvent;
        public virtual void OnRAWUART2MessageDecoded(byte[] msgPayload)
        {
            var handler = OnRAWUART2MessageDecodedEvent;
            if (handler != null)
            {
                handler(this, new DataReceivedArgs { Data = msgPayload });
            }
        }
        public event EventHandler<DataReceivedArgs> OnRAWUART3MessageDecodedEvent;
        public virtual void OnRAWUART3MessageDecoded(byte[] msgPayload)
        {
            var handler = OnRAWUART3MessageDecodedEvent;
            if (handler != null)
            {
                handler(this, new DataReceivedArgs { Data = msgPayload });
            }
