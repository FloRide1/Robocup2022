...
namespace MessageGeneratorNS
{
    public class MsgGenerator
    {
        ...
        public void GenerateMessageTir(object sender, TirEventArgs e)
        {
            ...
            payload.SetValueRange(e.coil1MS.GetBytes(), 0,2);
            payload.SetValueRange(e.coil2MS.GetBytes(), 2,2);
            payload.SetValueRange(e.coil3MS.GetBytes(), 4,2);
            payload.SetValueRange(e.coil4MS.GetBytes(), 6,2);
            payload.SetValueRange(e.coil2OffsetMS.GetBytes(), 8,2);
            payload.SetValueRange(e.coil3OffsetMS.GetBytes(), 10,2);
            payload.SetValueRange(e.coil4OffsetMS.GetBytes(), 12,2);
            OnMessageToRobot((Int16)Commands.PC2R_TirCommand, 14, payload);
        }
        ...
        public void GenerateMessageEnablUARTRAWRxForward(object sender, BoolEventArgs e)
        {
            byte[] payload = new byte[1];
            payload[0] = Convert.ToByte(e.value);
            OnMessageToRobot((Int16)Commands.PC2R_ForwardUartRAWDataEnable, 1, payload);
        }
        ...
        public void GenerateMessage4WheelsIndependantSpeedPIDSetup(object sender, IndependantPIDSetupArgs e)
        {
            ...
            OnMessageToRobot((Int16)Commands.PC2R_SpeedPIDEnableDebugInternal, 1, new byte[1] { 1 });
        }
        ...
        public void GenerateMessagePololuSetServoUs(object sender, PololuServoUsArgs e)
        {
            byte[] payload = new byte[4];
            payload[0] = 0x84;
            ...
            OnMessageToRobot((Int16)Commands.PC2R_PololuForward, 4, payload);
        }
