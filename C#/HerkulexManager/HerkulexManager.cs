...
namespace HerkulexManagerNS
{
    public class HerkulexManager
    {
        ...
        private HerkulexMsgProcessor msgProcessor;
        ...
        public HerkulexManager()
        {
            ...
            //msgProcessor = new HerkulexMsgProcessor();
            //decoder.OnRamReadAckEvent += msgProcessor.ProcessHerkulexDecodedMessage;
            //msgProcessor.OnTorqueFromHerkulexGeneratedEvent += OnTorqueInfoFromHerkulex;
        ...
        public virtual void OnTorqueInfoFromHerkulex(object sender,TorqueEventArgs e)
        {
        ...
        //On process la trame serie vers le manager de port série
        public void OnHerkulexDecodeInputData(object sender, DataReceivedArgs e)
        {
            decoder.DecodePacket(sender, e);
        }
        ...
        public void RAM_READ(ServoId pID, HerkulexDescription.RAM_ADDR startAddr, byte length)
        {
