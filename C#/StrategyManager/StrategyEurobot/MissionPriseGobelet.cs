...
{
    public class MissionPriseGobelet : MissionBase
    {
        double rayonRobot= 0.15;
        double longueurBrasRobot = 0.07;
        Gobelet GobeletCourant;
        ...
        public MissionPriseGobelet() : base()
        { }

        StrategyEurobot2021 parentStrategie;
        public MissionPriseGobelet(StrategyGenerique sg) : base(sg)
        {
        ...
        public void Start(Gobelet gob, double anglePrise, string bras)
        {
            GobeletCourant = gob;
