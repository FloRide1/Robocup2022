...
namespace StrategyManagerNS
{
    public class MissionDeposeGobelet : MissionBase
    {
        ...
        public MissionDeposeGobelet() : base()
        { }

        StrategyEurobot2021 parentStrategie;
        public MissionDeposeGobelet(StrategyGenerique sg) : base(sg)
        {
        ...
        public void Start(EmplacementDepose emplacement, string bras)
        {
                ...
                case MissionDeposeGobeletState.DEPOSE_Gobelet:
                    switch (subState)
                    {
                        ...
                        case SubTaskState.Exit:
                            ...
                            parentStrategie.matchDescriptor.DictionaryBrasTurbine[BrasUtilise].GobletCapturedColor = Color.Neutre;
