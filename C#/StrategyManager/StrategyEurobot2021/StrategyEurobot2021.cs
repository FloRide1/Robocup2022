...
namespace StrategyManagerNS
{
    ...
    public class StrategyEurobot2021 : StrategyGenerique
    {
        ...
        public Eurobot2021MatchDescriptor matchDescriptor;

        public Eurobot2021TaskGameManagement taskGameManagement;
        public Eurobot2021TaskDeplacementsParametersModifiers taskDeplacementsParametersModifiers;
        public Eurobot2021TaskAvoidanceParametersModifiers taskAvoidanceParametersModifiers;
        public Eurobot2021TaskAffichageLidar taskAffichageLidar;
        ...
        public Eurobot2021MissionRamassageAutomatique missionRamassageAutomatique;

        public Eurobot2021MissionLCDSM missionLCDSM;

        public StrategyEurobot2021(int robotId, int teamId, string teamIpAddress) : base(robotId, teamId, teamIpAddress)
        {
            matchDescriptor = new Eurobot2021MatchDescriptor(this);
            RayonRobot = 0.15;
        }
        ...
        public override void InitStrategy(int robotId, int teamId)
        {
            ...
            missionLCDSM = new Eurobot2021MissionLCDSM(this);
            listMissions.Add(missionLCDSM);
            missionRamassageAutomatique = new Eurobot2021MissionRamassageAutomatique(this);
            listMissions.Add(missionRamassageAutomatique);

            taskGameManagement = new Eurobot2021TaskGameManagement(this);
            listTasks.Add(taskGameManagement);
            taskAffichageLidar = new Eurobot2021TaskAffichageLidar(this);
            listTasks.Add(taskAffichageLidar);
            taskDeplacementsParametersModifiers = new Eurobot2021TaskDeplacementsParametersModifiers(this);
            listTasks.Add(taskDeplacementsParametersModifiers);
            taskAvoidanceParametersModifiers = new Eurobot2021TaskAvoidanceParametersModifiers(this);
        ...
        public enum Eurobot2021SideColor { Blue, Yellow };
        public enum Eurobot2021RobotType { RobotSud, RobotNord, None };
        public Eurobot2021SideColor playingColor = Eurobot2021SideColor.Blue;
        public enum Eurobot2021StrategyType { Soft, LaConchaDeSuMadre };
