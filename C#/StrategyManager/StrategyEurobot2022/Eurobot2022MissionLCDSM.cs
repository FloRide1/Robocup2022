...
{
    public class Eurobot2022MissionLCDSM : MissionBase
    {
        Eurobot2022PositionTerrain Cible;
        ...
        public Eurobot2022MissionLCDSM() : base()
        { }

        StrategyEurobot2022 parentStrategie;
        public Eurobot2022MissionLCDSM(StrategyGenerique sg) : base(sg)
        {
        ...
        public override void Init()
        {
            ...
            parent.OnPilotageTurbine((byte)Eurobot2022PilotageTurbineID.Turbine_soufflage, 1000);
            ResetSubState();
            isFinished = false;
        }

        public void Start(Eurobot2022PositionTerrain cible)
        {
            Cible = cible;
            isFinished = false;
                    ...
                    switch (subState)
                    {
                        ...
                        case SubTaskState.EnCours:
                            if (Math.Abs(parentStrategie.robotCurrentLocation.X) < 0.4)
                            {
                                ...
                                parent.OnPilotageTurbine((byte)Eurobot2022PilotageTurbineID.Turbine_soufflage, 1300);
                            }
                            else
                            {
                                parent.OnPilotageTurbine((byte)Eurobot2022PilotageTurbineID.Turbine_soufflage, 1000);
