...
namespace StrategyManagerNS
{
    public class Eurobot2022MissionDeposeGobelet : MissionBase
    {
        ...
        public Eurobot2022MissionDeposeGobelet() : base()
        { }

        StrategyEurobot2022 parentStrategie;
        public Eurobot2022MissionDeposeGobelet(StrategyGenerique sg) : base(sg)
        {
                ...
                case MissionDeposeGobeletState.DEPOSE_Gobelet:
                    switch (subState)
                    {
                        ...
                        case SubTaskState.Exit:
                            ...
                            parentStrategie.matchDescriptor.DictionaryBrasTurbine[BrasUtilise].GobletCapturedColor = Eurobot2022Color.Neutre;
