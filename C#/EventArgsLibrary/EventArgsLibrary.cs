...
namespace EventArgsLibrary
{
    ...
    {
        //public int RobotId { get; set; }
        public ushort coil1MS { get; set; }
        public ushort coil2MS { get; set; }
        public ushort coil3MS { get; set; }
        public ushort coil4MS { get; set; }
        public ushort coil2OffsetMS { get; set; }
        public ushort coil3OffsetMS { get; set; }
        public ushort coil4OffsetMS { get; set; }
    }
    ...
    public class RoleArgs : EventArgs
    {
        ...
        public RoboCupPoste Role { get; set; }
    }
    ...
    {
        public int RobotId { get; set; }
        public List<PointDExtended> PtList { get; set; }
    }
    ...
    public class TrajectoryGeneratorConstants : EventArgs
    {
        public int RobotId { get; set; }
